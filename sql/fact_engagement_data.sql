-- Creating a View to store the cleaned engagement data for easy access by BI tools
-- Query to clean and normalize the engagement_data table

CREATE VIEW dbo.vw_CleanedEngagementData AS
SELECT
...
SELECT * FROM vw_CleanedEngagementData